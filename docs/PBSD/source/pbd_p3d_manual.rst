...
.. toctree::
   ...
   2_data_conv_sheets
   3_modelling
   4_nonlinear_static_analysis
   5_nonlinear_dynamic_analysis
   6_post-processing


소프트웨어
^^^^^^^^^^^^^^
본 성능기반 내진설계 업무절차서에서는 Midas Gen과 Perform-3D 외에 다음의 소프트웨어들을 사용합니다.
...
.. warning::
   PBD_p3d를 사용하는 도중 오류가 발생하는 경우, 연구소로 문의해주세요.
   그러나 대부분의 경우, 성능기반 내진설계 업무절차서에 따라 모델링한다면 오류없이 진행이 가능합니다.
