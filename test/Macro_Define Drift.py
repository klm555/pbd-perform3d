...
# Story 정보 load
story_data = pd.read_excel(data_path + '\\' + Input_sheet_name, sheet_name='Story Data', keep_default_na=False, skiprows=[0, 2, 3], index_col= None).iloc[:, [1, 2]]
...
# Drift name 정보 load
drift_name = pd.read_excel(data_path + '\\' + Input_sheet_name, sheet_name='Output_Naming', keep_default_na=False, skiprows=[0, 2, 3], index_col= None).iloc[:, 6]
