...
############################ 처음에 입력해야 할 부분 ###########################
### 초기 경로 설정
input_path = r'D:\이형우\성능기반 내진설계\21-GR-222 광명 4R구역 주택재개발사업 성능기반내진설계\101' # Input Sheets 가 있는 폴더 경로
input_xlsx = '101D_Data Conversion_Ver.1.2.xlsx' # Input Sheets 이름
...
# Section 정보 불러오기
section_info = pd.read_excel(input_path + '\\' + input_xlsx
