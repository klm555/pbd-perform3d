...
beam_sheet = 'Output_C.Beam Properties'
...
beam_index = 931 # elem_info 에서 시작하고자 하는 material name의 index 입력, 처음부터일때는 0 입력
#####################################
##############################################################################################################
...
elem_info = pd.read_excel(data_path + '\\' + Input_sheet_name
                             , sheet_name = beam_sheet, skiprows=[0,2,3]).iloc[:,0]
