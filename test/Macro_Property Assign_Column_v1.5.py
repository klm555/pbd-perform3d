...
elem_index = 0 # wall_material_data_repeat 에서 시작하고자 하는 material name의 index 입력, 처음부터일때는 0 입력
#####################################
##############################################################################################################
...
# E.Column 정보 불러오기
elem_info = pd.read_excel(data_path, sheet_name = column_sheet, skiprows=[0,2,3]).iloc[:,0]
