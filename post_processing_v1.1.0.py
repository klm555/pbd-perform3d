...
# 전체 결과
output_docx = '108_2_해석결과.docx' 
# 벽체 전단(보강)           *** 보강 Sheet를 작성해야 부재별 결과확인 함수 실행가능
WSF_docx = '108_2_벽체_수평배근_보강.docx'
wall_retrofit_sheet = 'Results_Wall_보강 (1)'
# 연결보 전단(보강)
BSF_docx = '108_2_연결보_수평배근_보강.docx'
beam_retrofit_sheet = 'Results_C.Beam_보강 (1)'
# 기둥 전단(보강)
CSF_docx = '108_2_기둥_수평배근_보강.docx'
...
#%% Post Processing - INDIVIDUAL (Word로 출력) - 벽체 전단(보강)

# Execute functions for data analysis
WSF_each = pbd.WSF_each(input_xlsx_path, retrofit_sheet=wall_retrofit_sheet)
# output_to_docx 이용해서 결과 출력
